...
* In Strict Mode, double-render components without Hooks too. ([@eps1lon](https://github.com/eps1lon) en [#18430](https://github.com/facebook/react/pull/18430))
...
* Make `useCallback` behavior consistent with `useMemo` for the server renderer. ([@alexmckenley](https://github.com/alexmckenley) en [#18783](https://github.com/facebook/react/pull/18783))
...
* Eliminar the `timeoutMs` argumento. ([@acdlite](https://github.com/acdlite) en [#19703](https://github.com/facebook/react/pull/19703))
