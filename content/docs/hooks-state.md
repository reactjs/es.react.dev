...
**¿Cuándo debería usar un Hook?** Si creas un componente funcional y descubres que necesitas añadirle estado, antes había que crear una clase. Ahora puedes añadir un Hook dentro de un componente funcional existente.¡Vamos a hacerlo ahora mismo!
