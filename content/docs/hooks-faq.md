...
**También podrías querer ocasionalmente evitar re-crear el valor inicial de `useRef`.** Por ejemplo, tal vez quieres asegurarte que alguna instancia de una clase imperativa solo se cree una vez:
