...
* Dentro de estos métodos, el componente `Calculator` pregunta a React para re-renderizarse a sí mismo llamando al método `this.setState()` con el nuevo valor y la escala actual de la entrada que acabamos de editar.
