...
Cada [framework de React orientado a producción](https://react-dev-git-fork-orta-typescriptpage-fbopensource.vercel.app/learn/start-a-new-react-project#production-grade-react-frameworks) brinda compatibilidad para el uso de TypeScript. Consulta la guía específica de tu framework para su instalación:
